...
const AuthScreen = () => {
  ...
  // Handle form submission and navigate to the signup page with email as query parameter
  const handleFormSubmit = (e) => {
    e.preventDefault(); // Prevent page reload
    navigate("/signup?email=" + email); // Navigate to signup page
  };

  return (
    <div className='hero-bg relative'>
      {/* Navbar with logo and sign-in link */}
      ...
      {/* Hero section with intro text and email input */}
      ...
      {/* Section about downloading shows */}
      <div className='py-10 bg-black text-white'>
      ...
      {/* Section about watching everywhere */}
      <div className='py-10 bg-black text-white'>
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
          <div className='flex-1 text-center md:text-left'>
      ...
      {/* Section about creating profiles for kids */}
      <div className='py-10 bg-black text-white'>
        <div
